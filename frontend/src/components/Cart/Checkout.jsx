...
const Checkout = () => {
    ...
    useEffect(() => {
        // If cart does not exist or cart is empty, redirect to homepage
    ...
    const handleCreateCheckout = async (e) => {
        ...
        if (cart && cart.products.length > 0) {
            ...
            // If checkout was successful, set checkout ID
                ...
                <form onSubmit={handleCreateCheckout}>
                    ...
                    <div className="mt-6">
                        {!checkoutId ? (
                            ...
                            <div>
                                <h3 className="text-2xl mb-4 text-center font-bold italic mt-10">Pay with Paypal</h3>
                                {/* Paypal Component */}
